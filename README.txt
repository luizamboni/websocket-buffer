...
#Produtor:
	...
	- Produtor coloca números inteiros aleat�rios em Buffer. 
	- Um dos par�metros que ele recebe como inicialização define quantas Threads, ou seja, instâncias de Produtor serão 	
